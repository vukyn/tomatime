...
- [tomatime clay pomodoro UI](memory/tomatime-clay-pomodoro-ui.md) — clay theme; client-state only, NO backend
...
- [Chakra v3 gotchas](memory/chakra-v3-gotchas.md) — silent drops: inline keyframes, off-scale tokens, ghost Dialog
